...
public class AppLauncher {
    ...
    private static void launch(String[] args) throws Exception{
        ...
        String className = config.getString("survival.class");
    ...
    private static String matchClass(String className) throws Exception{
        ...
        ImmutableSet<ClassPath.ClassInfo> classes = classPath.getTopLevelClasses("edu.neu.ccs.survival.application");
